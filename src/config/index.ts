...
export { dailyPapers } from "./dailyPaperConfig"; // 每日文献推荐列表
export type { DailyPaper } from "./dailyPaperConfig";
...
export { resourceCategories, resourceLinks } from "./resourceConfig"; // 资源导航配置
export type { ResourceCategory, ResourceLink } from "./resourceConfig";
// 布局配置
